...
public class MCreatorCuteDirt extends Elementsnew_biome.ModElement {
	@ObjectHolder("new_biome:cutedirt")
	public static final Block block = null;

	public MCreatorCuteDirt(Elementsnew_biome instance) {
		super(instance, 2);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void animateTick(BlockState state, World world, BlockPos pos, Random random) {
			...
			Block block = this;
			{
				...
				MCreatorCuteDirtRandomTickUpdateEvent.executeProcedure($_dependencies);
			}
		}
	}
}
